...
plt.xlabel('ToT Difference: ToT_1 - ToT_2 (ns)', fontsize =12)
plt.ylabel('Position of Perpendicular Bar', fontsize =12)
plt.ylim(-2, 27)
...
plt.title('Time over Threshold (ToT) Difference vs Position of Perpendicular Bars', fontsize =15)
plt.legend()
